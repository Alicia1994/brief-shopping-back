...
import com.example.demo.dto.OrderDtoClient;
...
public class OrderController {
    ...
    @PostMapping("/{id}")
    public User CreateOrder(@PathVariable Long id, @RequestBody OrderDto orderDto){
        Optional<User> currentUser = userService.getUser(id);
        return orderService.SaveOrder(id, orderDto);
    }
